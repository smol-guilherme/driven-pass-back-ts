...
import { findAllByUserId, findById, insert, remove, softFindById, } from "../repositories/networkRepositories.js";
import { decryptSensitiveInfo, encryptSensitiveInfo, } from "./encryptionServices.js";
export function newNetworkRoutine(networkData, userId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    networkData.password = encryptSensitiveInfo(networkData.password);
                    return [4 /*yield*/, insert(networkData, userId)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
export function listNetworksRoutine(userId) {
    return __awaiter(this, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function getNetworkByIdRoutine(itemId, userId) {
    return __awaiter(this, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function deleteNetworkRoutine(itemId, userId) {
    return __awaiter(this, void 0, void 0, function () {
        var data, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
