...
import { findAllByUserId, findById, findTitleById, insert, remove, softFindById, } from "../repositories/documentRepositories.js";
import { decryptSensitiveInfo, encryptSensitiveInfo, } from "./encryptionServices.js";
export function newDocumentsRoutine(documentData, userId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, checkForDuplicateTitles(userId, documentData.title)];
                case 1:
                    _a.sent();
                    documentData.password = encryptSensitiveInfo(documentData.password);
                    documentData.CVV = encryptSensitiveInfo(documentData.CVV);
                    return [4 /*yield*/, insert(documentData, userId)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function checkForDuplicateTitles(id, DocumentsTitle) {
    return __awaiter(this, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, findTitleById(id, DocumentsTitle)];
                case 1:
                    data = _a.sent();
                    if (data !== null)
...
export function listDocumentsRoutine(userId) {
    return __awaiter(this, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function getDocumentByIdRoutine(itemId, userId) {
    return __awaiter(this, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function deleteDocumentsRoutine(itemId, userId) {
    return __awaiter(this, void 0, void 0, function () {
        var data, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
