...
import { deleteNotes, getSingleNote, listNotes, newNotes, } from "../controllers/notesControllers.js";
...
notesRouter.get("/notes/:id", clearData, validateData, validateToken, getSingleNote);
notesRouter.post("/notes", clearData, validateData, validateToken, newNotes);
notesRouter["delete"]("/notes/:id", clearData, validateData, validateToken, deleteNotes);
