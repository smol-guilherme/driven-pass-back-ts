...
export default function validateData(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var validationData, _a, _b, _i, index, schema;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    validationData = [req.params, req.body];
                    _a = [];
                    for (_b in validationData)
                        _a.push(_b);
                    _i = 0;
                    _c.label = 1;
                case 1:
                    ...
                    if (Object.keys(validationData[index]).length === 0)
                        return [3 /*break*/, 3];
                    schema = schemas[setSchema(validationData[index])];
                    return [4 /*yield*/, schema.validateAsync(validationData[index], {
                            abortEarly: false
                        })];
                case 2:
                    _c.sent();
...
function setSchema(objectData) {
    ...
    for (var i = 0; i < keys.length; i++) {
        switch (keys[i]) {
            ...
            case "password":
                if (keys.includes("repeatPassword"))
